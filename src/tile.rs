...
impl GetDirection for WhirlTile {
    fn get_direction(&self) -> Direction {
        match self {
            WhirlTile {clock_wise: true, top: true, left: true} => Direction::Right,
            WhirlTile {clock_wise: true, top: true, left: false} => Direction::Down,
            WhirlTile {clock_wise: true, top: false, left: true} => Direction::Up,
            WhirlTile {clock_wise: true, top: false, left: false} => Direction::Left,
            WhirlTile {clock_wise: false, top: true, left: true} => Direction::Down,
            WhirlTile {clock_wise: false, top: true, left: false} => Direction::Left,
            WhirlTile {clock_wise: false, top: false, left: true} => Direction::Right,
            WhirlTile {clock_wise: false, top: false, left: false} => Direction::Up
        }
    }
}

fn get_whirl(clock_wise: bool, top: bool, left: bool, s: &String) -> Tile {
    let whirl = WhirlTile {clock_wise: clock_wise, top: top, left: left};
    let tile = TileType::Whirl(whirl);

    Tile {tile: tile, id: s.clone(), direction: whirl.get_direction()}
}
...
#[test]
fn test_tiles() {
    let x = Tile {tile: TileType::Sea, id: String::from("s"), direction: Direction::None};
